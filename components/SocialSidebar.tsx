...
export default function SocialSidebar() {
  return (
    ...
    >
      <a
        href="http://linkedin.com/in/eric-frenek-lopez-rosales-650196348"
        target="_blank"
        ...
        aria-label="LinkedIn Remote Verification Channel"
      >
      ...
      <a
        ...
        rel="noopener noreferrer"
        className="text-slate-500 hover:text-blue-500 hover:-translate-y-1 transition-all duration-300 focus-visible:outline-none focus-visible:text-blue-500"
        aria-label="Source Control Engineering Channel"
      >
        <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
      ...
      <a
        ...
        rel="noopener noreferrer"
        className="text-slate-500 hover:text-blue-500 hover:-translate-y-1 transition-all duration-300 focus-visible:outline-none focus-visible:text-blue-500"
        aria-label="Public Transmission Broadcast Channel"
      >
        <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
